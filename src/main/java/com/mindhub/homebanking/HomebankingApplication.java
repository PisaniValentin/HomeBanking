...
public class HomebankingApplication {
	...
	public CommandLineRunner initData(ClientRepository clientRepository, AccountRepository accountRepository, TransactionRepository transactionRepository) {
		return (args) -> {
			...
			Transaction transaction1 = new Transaction(-1000,"Debito1", TransactionType.debito);
			Transaction transaction2 = new Transaction(-6000,"Debito2", TransactionType.debito);
			Transaction transaction3 = new Transaction(3000,"Credito1", TransactionType.credito);
			Transaction transaction4 = new Transaction(2500,"Credito2", TransactionType.credito);
